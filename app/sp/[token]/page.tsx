...
const SURVEY_SECTION_ID = "sp-questionnaire";
...
function SemanticDifferentialItem({
  ...
  return (
    <div className="mt-8" title={item.tooltip}>
...
export default async function SPSurveyPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-bg-primary py-[var(--spacing-section)] font-sans">
      <main className="mx-auto box-content w-full max-w-[1160px] px-6 md:px-8">
        <StimulusPackView
          pack={pack}
          variant="respondent"
          surveySectionId={SURVEY_SECTION_ID}
        />

        <form
          id={SURVEY_SECTION_ID}
          action={submitSPResponse}
