...
const POSITION_BTN =
  "flex h-[29px] w-fit items-center gap-[10px] border border-fg-primary bg-bg-elevated px-[12px] pt-[8px] pb-[7px] font-mono text-metadata text-fg-primary leading-none";
...
export default function ConceptQuadrant({ concept }: Props) {
  ...
  return (
    <div className="mt-[-1px] flex h-[194px] w-[1160px] border border-fg-primary bg-bg-elevated">
      <div className="flex w-[455px] shrink-0 flex-col px-[35px] py-[32px]">
        ...
        <button type="button" className={`${POSITION_BTN} mt-auto`}>
